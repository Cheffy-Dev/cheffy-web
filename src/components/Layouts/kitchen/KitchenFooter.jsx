...
class KitchenFooter extends Component {
  render() {
    return (
      <footer>
        {/* TODO: Fix LinkedIn and Facebook links. */}
        <Row justify="center" gutter={16}>
          <Col>
            <a
              target="_blank"
              href="https://www.instagram.com/cheffy.group/"
          ...
          <Col>
            <a
              target="_blank"
              href="https://twitter.com/Cheffy_official"
        ...
        <Row justify="center">
          <p className="text-gray-800 dark:text-white mb-16">
